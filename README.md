...
1. Keep plugin / root versions at the intended release (currently **`0.1.2`** for the next tag).
2. Push tag **`v<opencli-plugin.json version>`** exactly (e.g. `v0.1.2`). Do **not** move an existing published tag such as `v0.1.0`.
